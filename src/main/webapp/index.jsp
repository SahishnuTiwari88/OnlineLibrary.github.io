...
<title>Online library - Start Bootstrap Theme</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Unique Portal</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Online College Library</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - Web Development - Python -Novels</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Online library is a open source library system created by
						Sahishnu. It include various books related to the curriculum and other 
						books like Novels and much more which can be downloaded for free</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">You can create your own custom avatar and playlist 
					for the fun, change the icon in the dividers, and add your email
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Village Post Nagpur <br /> Mau, 276402
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<div class="col-lg-4">
					...
					<p class="lead mb-0">
						Online library is a free to use,  for fun and avatar creation.
						by <a href="http://startbootstrap.com">Start Learning</a> .
					</p>
				</div>
			</div>
		</div>
